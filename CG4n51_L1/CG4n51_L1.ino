...
float cantidadSegundoNivel1 = 1000;
...
int velocidadLineal1 = 3000;  //Numero entre 500 o 3500 dependiendo de las pruebas
...
int velocidadTaladro1 = 2200;  //Numero entre 500 o 3500 dependiendo de las pruebas
...
int pasosDespuesHome = 425;  // pasos que tiene que avanzar para ir despues de home 375
//CANTIDAD DE PASOS PRIMER NIVEL
int cantidadPasosPrimerNivel1 = 175;
...
//CANTIDAD DE PASOS DESPUES DE HOME
int pasosAcomodoParaSegundoNivel1 = 175;
...
int cantidadPasosSegundoNivel1 = 225;
...
void rotaciones_mas_cuatro() {
  float angulo_de_rotacion = 0.0;
  float distancia = 0.0;
  int numero_de_ciclos = 0;
  while (true) {
    delay(1000);
  }
}
...
void rotaciones_mas_cuatro() {
  ...
  float distancia = 0.0;
  int numero_de_ciclos = 0;
  Serial.println("Iniciando proceso de rotaciones adicionales...");
  for (int i = 0; i < 4; i++) {
    angulo_de_rotacion += 90.0;
    distancia += 5.0;
    numero_de_ciclos++;
    Serial.print("Ciclo "); Serial.println(numero_de_ciclos);
    delay(500);
  }
  Serial.println("Proceso detenido por inconsistencias en sensor principal.");
  while (true) {
    delay(1000);
  }
}
